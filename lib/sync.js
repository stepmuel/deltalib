...
Sync.prototype.sync = function() {
  ...
  if (this.storeid !== null) data.store = this.storeid;
...
Sync.prototype.unsubscribe = function(path, func, thisArg) {
  this.observer.off(path, func, thisArg);
};
